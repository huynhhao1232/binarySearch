    ...
    passwordInput.oninput= function(){
		...
		function weakPasswordStrength(passwordLength, poorPassword, weakPassword, strongPassword){
			if(passwordLength >= 8 && (poorPassword || weakPassword || strongPassword))
			{
			   ...
			   passwordInfo.innerHTML = '<img src="{% static \'assets/img/icon/anguish.svg\'%}" class="me-2">' + "Average. Must contain at least 1 letter or number";
		   ...
		   if(passwordLength>= 8 && poorPassword && (weakPassword || strongPassword))
			{
			 ...
			 passwordStrength.classList.remove("heavy-active");
			 passwordInfo.innerHTML = '<img src="{%static \'assets/img/icon/smile.svg\'}" class="me-2">' + "Almost. Must contain special symbol";
